      ...
      body: BlocProvider<SigninCubit>(
        ...
        child: BlocConsumer<SigninCubit, SigninState>(
          ...
          builder: (context, state) {
            ...
            if (state is AdminSigningInState) {
              LoadingView(title: 'Accediendo al Panel', description: 'Sincronizando registros de la comunidad...');
            }
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                HeaderText.four('Panel de Administración', color: AppColors.secondary), // Changed from "Bienvenido de nuevo"
