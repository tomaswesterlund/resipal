drop function if exists "public"."fn_register_new_payment"(p_user_id uuid, p_amount_in_cents integer, p_date timestamp with time zone, p_reference text, p_note text, p_receipt_path text);
