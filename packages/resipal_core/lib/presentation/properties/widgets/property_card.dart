  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: property.hasDebt ? AppColors.danger.withOpacity(0.3) : AppColors.success.withOpacity(0.3), width: 1),
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(20),
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
              ...
              Container(width: 6, color: property.hasDebt ? AppColors.danger : AppColors.success),
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: Row(
                              children: [
                                Icon(Icons.house_outlined, size: 20, color: AppColors.secondaryScale[400]),
                                const SizedBox(width: 8),
                                Flexible(child: HeaderText.five(property.name, color: AppColors.auxiliarScale[900]!)),
                              ],
                            ),
                          ),
                          Icon(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                'Deuda pendiente',
                                style: GoogleFonts.raleway(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.auxiliarScale[400]),
                              ),
                              AmountText.fromCents(
                                property.totalOverdueFeeInCents.toInt(),
                                //property.contract?.totalOverdueFeeInCents,
                                fontSize: 18,
                                color: property.hasDebt ? AppColors.danger : Colors.black87,
                              ),
                            ],
                          ),
                          TextButton(
